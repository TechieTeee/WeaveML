...
class LmdbCache {
    ...
    async joinedKeyResultToSortKeyCache(joinedKeyResult) {
        ...
        if (wrappedValue && wrappedValue.tomb === undefined && wrappedValue.value === undefined) {
            return new warp_contracts_1.SortKeyCacheResult(joinedKeyResult.key.split(this.subLevelSeparator)[1], wrappedValue);
        }
        if (wrappedValue && wrappedValue.tomb === false && wrappedValue.value != null) {
            return new warp_contracts_1.SortKeyCacheResult(joinedKeyResult.key.split(this.subLevelSeparator)[1], wrappedValue.value);
        }
        return null;
    }
    ...
    async kvMap(sortKey, options) {
        const rangeOptions = {
            start: (options === null || options === void 0 ? void 0 : options.reverse) ? options === null || options === void 0 ? void 0 : options.lt : options === null || options === void 0 ? void 0 : options.gte,
            end: (options === null || options === void 0 ? void 0 : options.reverse) ? options === null || options === void 0 ? void 0 : options.gte : options === null || options === void 0 ? void 0 : options.lt,
